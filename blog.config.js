...
const BLOG = {
  ...
  AUTHOR: 'fatekey', // 作者
  BIO: '菜狗🥬', // 作者简介
  LINK: 'https://blog.fatekey.icu', // 网站地址
  KEYWORDS: '网络安全, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: 'nucfatekey@gmail.com', // 邮箱
  CONTACT_WEIBO: '', // 你的微博个人主页
  CONTACT_TWITTER: '', // 你的twitter个人主页
  CONTACT_GITHUB: 'https://github.com/fatekey', // 你的github个人主页
