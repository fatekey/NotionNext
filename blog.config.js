...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1c1a8162226d80eb9e76e99d64fdc8b2,en:1c1a8162226d80eb9e76e99d64fdc8b2',
  THEME: process.env.NEXT_PUBLIC_THEME || 'endspace2', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 claude,endspace,endspace2(fork定制),example,fukasawa,fuwari,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '蓝队安全研究猿', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.fatekey.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '网络安全, 个人博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/avatar.webp', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
