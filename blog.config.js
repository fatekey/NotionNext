...
const BLOG = {
  ...
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || '9c3b4dddc3154a51907b19c863de01db',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'fatekey', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '菜狗', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.fatekey.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '网络安全, 博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'nucfatekey@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  FONT_SANS: [// 无衬线字体 例如'LXGW WenKai'
    'Menlo','Bitter', '"PingFang SC"', '-apple-system', 'BlinkMacSystemFont', '"Hiragino Sans GB"',
  ...
  MUSIC_PLAYER_AUDIO_LIST: [ // 示例音乐列表。除了以下配置外，还可配置歌词，具体配置项看此文档 https://aplayer.js.org/#/zh-Hans/
    {
      ...
      artist: '96猫',
      url: 'https://music.163.com/song/media/outer/url?id=1965919488.mp3',
      cover: 'http://p1.music.126.net/R49UV9yz7DSC1Tz9s5i_xQ==/109951167701124811.jpg'
    },
    {
      name: 'I Really Want to Stay At Your House',
      artist: '銘晴Halo',
      url: 'https://music.163.com/song/media/outer/url?id=2003621098.mp3',
      cover: 'http://p1.music.126.net/ba7VHk468Nb0n9yyK6wVxw==/109951168111307638.jpg'
    },
    {
      name: '決別の旅',
      artist: 'Yonder Voice / 瑶山百霊',
      url: 'https://music.163.com/song/media/outer/url?id=34072418.mp3',
      cover: 'http://p2.music.126.net/juUqhD4PumKs5xfdgReZ7Q==/2528876746537453.jpg'
    }
  ],
  ...
  MUSIC_PLAYER_METING_ID: process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '8413148463', // 对应歌单的 id
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'https://twikoo-zeabur-production-2960.up.railway.app/', // TWIKOO地址 腾讯云环境填 envId；Vercel 环境域名地址（https://xxx.vercel.app)
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '217da818-4952-44f5-8e48-24c57340a2bd', // data-app-id 36位 see https://cusdis.com/
