...
export const Style = () => {
  return (
    <style jsx global>{`
      ...
      #theme-endspace2 a, #theme-endspace2 button, #theme-endspace2 [role="button"], #theme-endspace2 .cursor-pointer {
      ...
      #theme-endspace2 .aplayer.aplayer-fixed,
      #theme-endspace2 ~ .aplayer.aplayer-fixed,
